...
const FAQPage = () => {
  const faqs = [
    ...
    },
    {
      ...
      a: "Regular Menfess gratis tapi terbatas 17 tweet per hari dan 1 tweet per hari per user. Paid Menfess berbayar Rp2.800 dengan keuntungan: bisa kirim video, dijamin terkirim, dan diproses manual oleh admin pada jam 20.00 atau 22.00 WIB."
    },
    {
