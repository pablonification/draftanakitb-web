...
export async function POST(request) {
    return new Promise((resolve, reject) => {
        upload.single('attachment')(request, {}, async (err) => {
            if (err) {
            ...
            try {
                ...
                const formData = request.body; // Already handled by multer
                ...
                const transaction = new Transaction({
                    ...
                    amount: amount,
                    status: 'UNPAID',
                    mediaFileId: mediaFileId, // Store GridFS file ID
                    createdAt: new Date()
                });
